...
export const StorefrontFooter = () => {
  ...
  const footerGroups = [
    ...
    },
    {
      ...
      title: "Sell With Us",
      links: [
        { label: "Sell on Office Connect", href: "/seller-central" },
        { label: "12-Step Merchant Onboarding", href: "/seller-central/onboarding" },
        { label: "Seller Central Cockpit", href: "/vendor-dashboard" },
        { label: "Fee Schedule & Calculator", href: "/seller-central#document-checklist" },
