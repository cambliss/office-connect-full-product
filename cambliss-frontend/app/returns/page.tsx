    ...
    <StorefrontShell>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8 pb-32 select-none">
        ...
        {filteredTickets.length === 0 ? (
          <div className="p-12 text-center border border-dashed border-slate-200 rounded-[8px] bg-white space-y-3">
            <span className="text-3xl">🔄</span>
            <h3 className="text-base font-black text-slate-900">No return requests found</h3>
            <p className="text-xs text-slate-500 max-w-md mx-auto">
              You do not have any active or past RMA returns. All platform orders are covered under 100% Escrow Protection with doorstep pickup support.
            </p>
            <div className="pt-2">
              <Link
                href="/orders"
                className="inline-block px-5 py-2 rounded-[4px] bg-[#404d85] text-white font-bold text-xs hover:bg-[#323d6a] transition shadow-xs"
              >
                View My Orders
              </Link>
            </div>
