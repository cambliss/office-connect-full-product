...
export default function OrderConfirmationPage({ params }: { params: Promise<{ orderId: string }> }) {
  ...
  const orderData = {
    ...
    paymentMethod: "Platform Escrow Authorization",
    escrowStatus: "Secured in Escrow Vault",
    totalAmount: 0,
    deliveryAddress: {
      fullName: "Registered Account Customer",
      addressLine1: "Verified Delivery Location",
      city: "Bengaluru",
      state: "Karnataka",
      pincode: "560103",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-8 pb-32 select-none">
        ...
        <div className="text-center space-y-3 p-8 rounded-[12px] bg-slate-50 border border-slate-200">
          ...
          <p className="text-xs sm:text-sm text-slate-600 max-w-lg mx-auto leading-relaxed">
            Thank you! Your order is securely protected in platform escrow. When merchant dispatches your package, AWB tracking will update in real-time.
          </p>
        ...
        {orderData.packages.length > 0 && (
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {orderData.packages.map((pkg: any) => (
                <div
                  key={pkg.packageId}
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <strong className="text-slate-900 text-sm font-black">{formatINR(pkg.price * pkg.qty)}</strong>
                  </div>
