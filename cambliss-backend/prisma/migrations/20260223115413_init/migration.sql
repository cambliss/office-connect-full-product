-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'PROJECT_MANAGER', 'EMPLOYEE', 'CLIENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "OrganizationUser_organizationId_userId_roleId_key" ON "OrganizationUser"("organizationId", "userId", "roleId");
